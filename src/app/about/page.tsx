    ...
    <div className="about-container" style={{ maxWidth: 1040, margin: '0 auto', padding: '40px 20px 80px' }}>
      ...
      >
        <div style={{ display: 'inline-flex', alignItems: 'center', gap: 6, background: 'rgba(99, 102, 241, 0.1)', border: '1px solid rgba(99, 102, 241, 0.25)', borderRadius: 20, padding: '4px 12px', marginBottom: 16 }}>
          ...
          <span style={{ fontSize: 12, fontWeight: 700, letterSpacing: '0.05em', color: '#4338ca', textTransform: 'uppercase' }}>
            Independent AI Software Directory
          </span>
        </div>

        <h1 style={{ fontSize: 'clamp(2rem, 4vw, 2.75rem)', fontWeight: 800, margin: '0 0 14px', color: '#0f172a', letterSpacing: '-0.02em' }}>
          About Stack AI Tools
        </h1>

        <p style={{ fontSize: 16, color: '#475569', lineHeight: 1.65, margin: 0, maxWidth: 680 }}>
      ...
      {/* How We Vet Tools */}
      <div style={{ background: '#ffffff', border: '1px solid rgba(15, 23, 42, 0.08)', borderRadius: 20, padding: 32, marginBottom: 40, boxShadow: '0 4px 16px rgba(15, 23, 42, 0.05)' }}>
        <h2 style={{ fontSize: 22, fontWeight: 800, margin: '0 0 18px', color: '#0f172a' }}>
          How We Vet Every Tool
        </h2>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 20 }}>
          <div style={{ display: 'flex', gap: 12 }}>
            <Layers size={18} color="#4f46e5" style={{ flexShrink: 0, marginTop: 2 }} />
          ...
          <div style={{ display: 'flex', gap: 12 }}>
            <Compass size={18} color="#4f46e5" style={{ flexShrink: 0, marginTop: 2 }} />
            <p style={{ fontSize: 13.5, color: '#475569', margin: 0, lineHeight: 1.6 }}>
