  ...
  return (
    <div style={{ minHeight: '100vh', paddingBottom: 80 }}>
          ...
          return (
            <button
              ...
              style={{
                ...
                fontWeight: 600,
                cursor: 'pointer',
                border: isActive ? '1px solid var(--arcade-cyan)' : '1px solid rgba(255, 255, 255, 0.1)',
                background: isActive ? 'linear-gradient(135deg, rgba(56, 189, 248, 0.2), rgba(99, 102, 241, 0.15))' : 'rgba(255, 255, 255, 0.03)',
            ...
            >
              ...
              <span>{cat}</span>
              {cat === 'All Connectors' && (
                <span style={{ fontSize: 11, background: 'rgba(255,255,255,0.1)', padding: '2px 7px', borderRadius: 10 }}>
                  {connectors.length}
                </span>
              )}
            </button>
      ...
      <div style={{ maxWidth: 680, margin: '0 auto 36px', position: 'relative' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: 10, padding: '0 8px', fontSize: 12.5, color: '#94a3b8' }}>
          ...
          return (
            ...
            >
              ...
              <div>
                ...
                {/* Description */}
                <p style={{ color: '#cbd5e1', fontSize: 13.5, lineHeight: 1.6, margin: '0 0 16px', minHeight: 64 }}>
                  {c.description}
                </p>
      ...
      <section style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          ...
          <h2 style={{ fontSize: '1.85rem', fontWeight: 800, color: '#fff', margin: '6px 0 10px' }}>
            How to Install Claude Connectors & Plugins (MCP)
          </h2>
          <p style={{ color: '#94a3b8', maxWidth: 640, margin: '0 auto', fontSize: 14.5 }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 20 }}>
          <div style={{ background: 'rgba(255, 255, 255, 0.03)', border: '1px solid rgba(255, 255, 255, 0.08)', borderRadius: 12, padding: 22 }}>
            ...
            <h4 style={{ color: '#fff', margin: '0 0 8px', fontSize: 15 }}>Locate Your Config File</h4>
          ...
          <div style={{ background: 'rgba(255, 255, 255, 0.03)', border: '1px solid rgba(255, 255, 255, 0.08)', borderRadius: 12, padding: 22 }}>
            ...
            <h4 style={{ color: '#fff', margin: '0 0 8px', fontSize: 15 }}>Paste Connector JSON</h4>
            <p style={{ color: '#94a3b8', fontSize: 13, lineHeight: 1.6, margin: '0 0 12px' }}>
              Click <strong>&ldquo;Copy Claude Config&rdquo;</strong> on any connector card above and merge it into your <code style={{ color: '#38bdf8' }}>mcpServers</code> dictionary.
            </p>
          ...
          <div style={{ background: 'rgba(255, 255, 255, 0.03)', border: '1px solid rgba(255, 255, 255, 0.08)', borderRadius: 12, padding: 22 }}>
            ...
            <h4 style={{ color: '#fff', margin: '0 0 8px', fontSize: 15 }}>Restart Claude Desktop</h4>
            <p style={{ color: '#94a3b8', fontSize: 13, lineHeight: 1.6, margin: '0 0 12px' }}>
            ...
            <div style={{ background: 'rgba(16, 185, 129, 0.1)', border: '1px solid rgba(16, 185, 129, 0.2)', padding: '8px 12px', borderRadius: 6, fontSize: 12, color: '#34d399' }}>
        ...
        >
          ...
          >
            ...
            <div style={{ background: 'rgba(255, 255, 255, 0.03)', border: '1px solid rgba(255, 255, 255, 0.08)', borderRadius: 10, padding: 14, marginBottom: 20 }}>
              <span style={{ fontSize: 11, fontWeight: 700, color: 'var(--arcade-gold)', textTransform: 'uppercase', letterSpacing: '0.04em' }}>
                Tested Prompt to Run in Claude:
              </span>
              <p style={{ margin: '6px 0 0', color: '#f8fafc', fontSize: 13, fontStyle: 'italic' }}>
            ...
            <div style={{ marginBottom: 24 }}>
              <span style={{ fontSize: 12, fontWeight: 700, color: '#fff', display: 'block', marginBottom: 6 }}>
