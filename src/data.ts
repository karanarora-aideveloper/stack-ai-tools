...
export const aiTools: AITool[] = [
  {
    ...
    description: 'The world\'s first autonomous AI software engineer, now running on the SWE-1.7 model. Plans complex tasks, navigates repositories, executes shell commands, fixes bugs, and opens pull requests.',
    pricingModel: 'Paid',
    priceClass: 'paid',
  ...
  },
  {
    ...
    description: 'The default frontier visual generator as of 2026. Features the v8.1 Edit Engine, immaculate photorealism, and pixel-perfect typography.',
    pricingModel: 'Paid',
    priceClass: 'paid',
  ...
  },
  {
    ...
    description: 'Next-generation Answer Engine synthesizing verified web sources, now routing Deep Research through Claude Opus 4.6 for multi-hour research reports, decks, and dashboards.',
    pricingModel: 'Freemium',
    priceClass: 'freemium',
  ...
  },
  {
    ...
    description: 'Frontier streaming speech synthesis engine, now on the Sonic-3.6 model, delivering lifelike voice generation at sub-100ms time-to-first-audio across 44 languages for conversational voice agents.',
    pricingModel: 'Freemium',
    priceClass: 'freemium',
  ...
  },
  {
    ...
    description: 'The golden benchmark in generative audio, powered by the Eleven v3 model, with Audio Tags for emotional control, 70+ language support, and real-time multilingual dubbing.',
    pricingModel: 'Freemium',
    priceClass: 'freemium',
  ...
  {
    id: 16,
    name: 'Synthesia 3.0 (Video Agents)',
    category: 'Video',
    icon: '🎥',
    domain: 'synthesia.io',
    logoUrl: 'https://www.google.com/s2/favicons?domain=synthesia.io&sz=128',
    description: 'Corporate AI avatar video platform now featuring Video Agents that hold real-time conversations, Express-2 full-body expressive avatars, and instant enterprise training generation.',
    pricingModel: 'Paid',
    priceClass: 'paid',
  ...
  {
    id: 28,
    name: 'Leonardo Phoenix 2.0',
    category: 'Design',
    icon: '🦁',
    domain: 'leonardo.ai',
    logoUrl: 'https://www.google.com/s2/favicons?domain=leonardo.ai&sz=128',
    description: "Leonardo.Ai's foundational image model, now on Phoenix 2.0, with 95% prompt adherence, coherent in-image text rendering, LoRA fine-tuning, and a Consistent Character Engine for professional concept art, product photography, and editorial illustration workflows.",
    pricingModel: 'Freemium',
    priceClass: 'freemium',
  ...
  {
    id: 39,
    name: 'CapCut AI Studio (Video Studio)',
    category: 'Video',
    icon: '✂️',
    domain: 'capcut.com',
    logoUrl: 'https://www.google.com/s2/favicons?domain=capcut.com&sz=128',
    description: 'Leading content creation suite with a timeline-free Video Studio workspace, Seedream image generation, smart AI voiceovers, and instant auto-captioning.',
    pricingModel: 'Freemium',
    priceClass: 'freemium',
  ...
  },
  {
    ...
    description: 'Vercel\'s full-stack AI development tool. Translates prompts and screenshots into production-ready apps with a sandboxed runtime, native GitHub integration, API routes, and database connections.',
    pricingModel: 'Freemium',
    priceClass: 'freemium',
    link: 'https://v0.dev',
    rating: 4.92,
    reviewsCount: 15400,
    tags: ['Generative UI', 'GitHub Integration', 'shadcn/ui', 'Full-Stack'],
    badge: 'UI Builder'
  },
  {
    id: 44,
  ...
  },
  {
    ...
    description: 'Industry-leading open-weight graphic design and visual generator. Renowned for rendering legible, beautifully styled typography, posters, logos, and T-shirt mockups.',
    pricingModel: 'Freemium',
    priceClass: 'freemium',
  ...
  },
  {
    ...
    description: 'Professional design canvas powered by AI. Generates infinitely scalable, editable native vector SVG illustrations, 3D clay graphics, brand color palettes, and icon sets.',
    pricingModel: 'Freemium',
    priceClass: 'freemium',
  ...
  {
    id: 50,
    name: 'Magnific AI (Precision V2)',
    category: 'Design',
    icon: '🔍',
    domain: 'magnific.ai',
    logoUrl: 'https://www.google.com/s2/favicons?domain=magnific.ai&sz=128',
    description: 'Ultra-high resolution AI upscaler and hallucinating enhancer, now on the Precision V2 model. Re-imagines fine textures, skin pores, hair, and cinematic details up to 16x resolution.',
    pricingModel: 'Paid',
    priceClass: 'paid',
  ...
  },
  {
    ...
    description: 'Kling 3.0 Turbo with the Omni engine (June 2026): native 4K output, up to 15 seconds of continuous footage per generation, lip-synced multilingual audio in 5 languages, a Multi-Shot feature for up to six connected camera shots, and Elements 3.0 for video-clip-based character references.',
    pricingModel: 'Freemium',
    priceClass: 'freemium',
  ...
  },
  {
    ...
    description: 'High-speed generative video model, now on the Ray 3 engine, producing realistic native 1080p cinematic shots with rich camera controls (dolly, pan, tilt, orbit) and spatial 3D consistency.',
    pricingModel: 'Freemium',
    priceClass: 'freemium',
  ...
  },
  {
    ...
    description: 'Playful and creative video generation suite with stable multi-second object consistency. Features Pikaffects physics effects (crush, melt, explode, inflate), PikaStream real-time video, lip-sync, and sound effects.',
    pricingModel: 'Freemium',
    priceClass: 'freemium',
    link: 'https://pika.art',
    rating: 4.84,
  ...
  },
  {
    ...
    useCases: [
      ...
      'Record or upload your own voice with the Voices feature to sing on AI-composed tracks',
      'Train a personalized Custom Model on your own catalog so new songs match your sound'
    ],
    complexity: 'Intermediate',
    ...
    editorialReview: "Suno v5.5 produces complete 3-4 minute broadcast-ready musical tracks across any genre—from cinematic orchestral film scores to heavy metal, pop anthems, and neo-soul. Its Voices feature lets creators sing on their own tracks with no studio setup, Custom Models learn an artist's sound from as few as 6 uploaded tracks, and My Taste applies a creator's preferred genres and moods automatically. Its audio stems separation feature lets creators extract vocal and instrumental tracks independently.",
    ...
    pros: [
      ...
      'Voices and Custom Models let creators personalize output to their own singing voice and sound',
  ...
  {
    id: 66,
    name: 'Murf AI (Speech Gen 2)',
    category: 'Audio',
    icon: '🎙️',
    domain: 'murf.ai',
    logoUrl: 'https://www.google.com/s2/favicons?domain=murf.ai&sz=128',
    description: 'Versatile studio voice generator, now on the Speech Gen 2 model, turning scripts into studio-grade voiceovers with 200+ natural voices across 35 languages and customizable pitch, speed, and emphasis.',
    pricingModel: 'Freemium',
    priceClass: 'freemium',
    link: 'https://murf.ai',
    rating: 4.85,
  ...
  },
  {
    ...
    category: 'Video',
    icon: '🎬',
    logoUrl: 'https://www.google.com/s2/favicons?domain=sora.com&sz=128',
    domain: 'sora.com',
    description: "OpenAI's Sora 2 video generation model, producing 10-25 second clips with synchronized audio, dialogue, physics-accurate motion, and character cameos, available via API (standalone app discontinued; API scheduled to sunset Sept 24, 2026).",
    pricingModel: 'Paid',
    priceClass: 'paid',
    link: 'https://sora.com',
    rating: 4.85,
    reviewsCount: 21000,
    tags: ['Text-to-Video', 'OpenAI', 'Cinematic', 'Generative Video'],
    featured: true
  },
  {
    id: 501,
    ...
    category: 'Code',
    icon: '🔵',
    logoUrl: 'https://www.google.com/s2/favicons?domain=continue.dev&sz=128',
    domain: 'continue.dev',
    description: 'Open-source AI code assistant for VS Code and JetBrains with Chat, Autocomplete, Edit, and Agent Mode (autonomous multi-file task planning and execution), using any LLM including local models via Ollama.',
    pricingModel: 'Free',
    priceClass: 'free',
    link: 'https://continue.dev',
    rating: 4.7,
    reviewsCount: 5400,
    tags: ['Open Source', 'IDE Extension', 'Any Model', 'Autocomplete']
  },
  {
    id: 502,
    name: 'Cline',
    ...
    domain: 'cline.bot',
    description: 'Open-source autonomous coding agent (v3.81+) that reads/writes files, runs terminal commands, and drives a real browser, with approval at each step. Runs in VS Code, JetBrains, Cursor, Windsurf, Zed, and Neovim, with 30+ LLM providers supported.',
    pricingModel: 'Free',
    priceClass: 'free',
    link: 'https://cline.bot',
    rating: 4.8,
    reviewsCount: 6200,
    tags: ['Open Source', 'Autonomous Agent', 'Bring Your Own Key', 'VS Code']
  },
  {
    id: 503,
    ...
    category: 'Code',
    icon: '🦘',
    logoUrl: 'https://www.google.com/s2/favicons?domain=roomote.dev&sz=128',
    domain: 'roomote.dev',
    description: "A fork of Cline with multi-agent modes (Architect, Code, Debug, Ask). The team is discontinuing the original VS Code extension, Cloud, and Router services (May 2026) in favor of Roomote, a cloud-based agent that runs tasks end-to-end across Slack, GitHub, and Linear.",
    pricingModel: 'Free',
    priceClass: 'free',
    link: 'https://roomote.dev',
    rating: 4.75,
    reviewsCount: 3800,
    tags: ['Open Source', 'mcp-server', 'Custom Modes', 'VS Code']
  },
  {
    id: 504,
    ...
    category: 'Video',
    icon: '🎥',
    logoUrl: 'https://www.google.com/s2/favicons?domain=hailuoai.video&sz=128',
    domain: 'hailuoai.video',
    description: "MiniMax's flagship video generation model (Hailuo H3, released July 2026), producing clips up to 15 seconds at native 2K (2560x1440) resolution with synchronized audio and an omni-reference control system for consistent characters across scenes.",
    pricingModel: 'Freemium',
    priceClass: 'freemium',
    link: 'https://hailuoai.video',
    rating: 4.75,
    reviewsCount: 8600,
    tags: ['Text-to-Video', 'Image-to-Video', 'Physical Realism']
  },
  {
    id: 505,
    name: 'Qwen3-Coder',
    ...
    domain: 'qwenlm.ai',
    description: "Alibaba's current flagship open-weights coding model family, including the 480B-parameter Qwen3-Coder-480B-A35B-Instruct (MoE) and the lightweight Qwen3-Coder-Next, delivering agentic coding performance comparable to Claude Sonnet. Self-hostable or via API.",
    pricingModel: 'Free',
    priceClass: 'free',
    link: 'https://qwenlm.ai',
    rating: 4.7,
    reviewsCount: 4900,
    tags: ['Open Weights', 'Self-Hosted', 'Code Generation']
  },
  {
    id: 506,
    name: 'InVideo',
    ...
    domain: 'invideo.io',
    description: "AI video creation platform built around an agent model: describe a creative brief and InVideo handles scriptwriting through final editing. Features GlobalVoice (140-language dubbing with lip-sync), voice cloning, and bundled access to both OpenAI Sora 2 and Google Veo 3.1 in one subscription.",
    pricingModel: 'Freemium',
    priceClass: 'freemium',
    link: 'https://invideo.io',
    rating: 4.6,
    reviewsCount: 14200,
    tags: ['Text-to-Video', 'Templates', 'Stock Footage', 'Voiceover']
  },
  {
    id: 507,
    name: 'Fliki',
    category: 'Video',
    icon: '✨',
    logoUrl: 'https://www.google.com/s2/favicons?domain=fliki.ai&sz=128',
    domain: 'fliki.ai',
    description: 'Text-to-video and text-to-speech platform with a 2,000+ voice library across 80+ languages, photo-to-talking-avatar generation, AI dubbing, and an integrated AI image generator for scenes without stock footage.',
    pricingModel: 'Freemium',
    priceClass: 'freemium',
    link: 'https://fliki.ai',
    rating: 4.65,
    reviewsCount: 9700,
    tags: ['Text-to-Video', 'Text-to-Speech', 'Blog-to-Video']
  },
  {
    id: 508,
    name: 'PlayHT',
    ...
    domain: 'play.ht',
    description: "AI voice generator and text-to-speech API, now on the PlayHT 3.0 model (August 2026) with more expressive prosody and long-form stability, a 900+ voice library across 142 languages, plus Play 3.0 mini for real-time conversational AI and sub-300ms Turbo streaming.",
    pricingModel: 'Freemium',
    priceClass: 'freemium',
    link: 'https://play.ht',
    rating: 4.6,
    reviewsCount: 6800,
    tags: ['Text-to-Speech', 'Voice Cloning', 'API', 'Multilingual']
  },
  {
    id: 509,
    ...
    domain: 'stability.ai',
    description: "Stability AI's current flagship open-weights image model (SD4, announced April 2026), moving from the U-Net to a diffusion transformer (DiT) architecture. SD4 Ultra targets native 4096x4096 output with a dedicated text-rendering module fixing illegible in-image text. SD3.5 remains available for lighter workloads.",
    pricingModel: 'Free',
    priceClass: 'free',
    link: 'https://stability.ai',
    rating: 4.7,
    reviewsCount: 27000,
    tags: ['Open Weights', 'Self-Hosted', 'Text-to-Image', 'Fine-Tunable'],
    featured: true
  },
  {
    id: 510,
    ...
    logoUrl: 'https://www.google.com/s2/favicons?domain=github.com&sz=128',
    domain: 'github.com',
    description: "GitHub's AI pair programmer with Agent Mode (GA since March 2026) for autonomous multi-file task planning and execution, organization-level custom agents, and model choice across GPT-5.4, Claude Opus 4.6, Gemini, and o3 depending on plan tier.",
    pricingModel: 'Freemium',
    priceClass: 'freemium',
    link: 'https://github.com/features/copilot',
    rating: 4.5,
    reviewsCount: 48000,
    tags: ['IDE Extension', 'Autocomplete', 'Enterprise', 'Multi-Model'],
    featured: true
  },
  {
    id: 511,
    ...
    description: "OpenAI's open-source automatic speech recognition model (Large-v3 / v3-turbo, trained on 680,000 hours of audio) for multilingual transcription, translation, and timestamps across 99 languages, with native speaker diarization and streaming support.",
    pricingModel: 'Free',
    priceClass: 'free',
